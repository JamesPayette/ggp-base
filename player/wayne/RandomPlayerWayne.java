...
public class RandomPlayerWayne extends GGPlayer {
	...
	public static void main(String[] args) {
		Player.initialize(new RandomPlayerWayne().getName());
	}
	...
	public Move play(long timeout)
		...
		Move chosenMove = legalMoves.get(new Random().nextInt(legalMoves.size()));
