...
public class RewardHeuristicMinimaxPlayerWayne extends GGPlayer {

	final static long timeBuffer = 2000;
	...
	public static void main(String[] args) {
		Player.initialize(new RewardHeuristicMinimaxPlayerWayne().getName());
	}
