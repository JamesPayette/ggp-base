...
public class FactoringPropNetPlayer extends GGPlayer {
	...
	public static void main(String[] args) {
		Player.initialize(new FactoringPropNetPlayer().getName());
	}
	...
	public StateMachine getInitialStateMachine() {
		return new CachedStateMachine(new FactoringPropNetStateMachine());
	}

	@Override
	public String getName() {
		return "factoring_propnet_player";
	}
}
